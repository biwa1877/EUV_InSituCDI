function [dynamic,static,err] = inSituRecon_GPU_active(ESWft,maskStatic,maskDynamic,static,probe,dynamic,Ni,sphs0,gamma,plotFreq)
%
...
%         temp = circshift(static,[0,0,1]);
        StP = gamma*static(:,:,mod(tt+(Nt-2),Nt)+1)+(1-gamma)*static(:,:,tt);
